...
module.exports = {
	...
	theme: {
		extend: {
			...
			backgroundImage: {
				illustration: "url('assets/img/illustration.png')",
				bg: "url('assets/img/nftbull_bg.png')",
				'dark-noise': "url('assets/img/noise_texture.png')",
		...
		fontFamily: {
			// sans: ['Aileron Heavy', 'Montserrat', ...defaultTheme.fontFamily.sans],
