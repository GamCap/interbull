...
export default function Wallet({ open, setOpen }) {
	const { connect, connectors, data, reset } = useConnect();
	...
	return (
		<Transition.Root show={open} as={Fragment} afterLeave={() => handleAfterLeave()}>
			<Dialog as="div" className="fixed inset-0 z-10 overflow-y-auto p-4 sm:p-6 md:p-20 md:px-60 lg:px-80" onClose={setOpen}>
				<Transition.Child
					as={Fragment}
						...
						{isConnected ? (
							<>
								<div className="py-4 px-6 rounded-t border-b dark:border-gray-600">
									<h3 className="text-base font-semibold text-gray-900 lg:text-xl dark:text-white">Account</h3>
								</div>
								<div className="p-6">
									<p className="text-sm font-normal text-gray-500 dark:text-gray-400">Check your wallet details here.</p>
									<div className="my-4 space-y-3">
										{connectors[0].id === connector?.id && (
											<div className="flex items-center p-3 text-base font-bold text-gray-900 bg-gray-50 rounded-lg hover:bg-gray-100 group hover:shadow dark:bg-gray-600 dark:hover:bg-gray-500 dark:text-white">
												...
												<span className="inline-flex items-center flex-1 ml-3 whitespace-nowrap">
													MetaMask
												...
												<span
													onClick={() => disconnect()}
													className="cursor-pointer inline-flex items-center justify-center px-2 py-0.5 ml-3 text-xs font-medium text-pink-500 bg-pink-200 rounded dark:bg-gray-700 dark:text-gray-400"
												>
													Disconnect
												</span>
											</div>
										)}
										{connectors[1].id === connector?.id && (
											<div
												onClick={() => {
										...
										<div className="space-x-2">
											<button
												...
												className="inline-flex items-center text-sm font-normal text-gray-500 hover:underline dark:text-gray-400"
											>
												<DuplicateIcon className="mr-2 w-4 h-4"></DuplicateIcon>
												Copy address
											</button>
											<a
												...
												className="inline-flex items-center text-sm font-normal text-gray-500 hover:underline dark:text-gray-400"
											>
												<ExternalLinkIcon className="mr-2 w-4 h-4"></ExternalLinkIcon>
												View on Explorer
											</a>
										</div>
									</div>
							...
							<>
								{/* Modal header */}
								<div className="py-4 px-6 rounded-t border-b dark:border-gray-600">
									<h3 className="text-base font-semibold text-gray-900 lg:text-xl dark:text-white">Connect wallet</h3>
								</div>
								{/* Modal body */}
								<div className="p-6">
